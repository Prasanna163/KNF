...
def _build_pipeline(
    ...
    return KNFPipeline(
        ...
        compute_scdi=bool(getattr(args, "compute_scdi", False)),
...
def process_file(file_path: str, args, output_root: str = None, batch_size: int = 1, progress_callback=None):
    ...
    for attempt in range(1, attempts + 1):
        try:
            ...
            try:
                with open(r"D:\Prasubby\NCIForge\job_debug.log", "a", encoding="utf-8") as f:
                    f.write(f"[PROCESS_FILE_ERROR] Error processing {file_path}:\n{tb}\n")
            except Exception:
                pass
